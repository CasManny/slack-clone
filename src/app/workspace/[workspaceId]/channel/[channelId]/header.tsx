...
const Header = ({ title }: HeaderProps) => {
  ...
  const [ConfirmDialog, confirm] = useConfirm(
    "Delete this channel",
    "This action is irreversible. The channel will be deleted"
  );
          ...
          <div className="px-4 pb-4 flex-col gap-y-2">
            ...
            {member?.role === "admin" && (
              <button
                ...
                className="flex items-center gap-x-2 px-5 py-4 bg-white rounded-lg cursor-pointer border hover:bg-gray-50 text-rose-600 w-full"
              >
